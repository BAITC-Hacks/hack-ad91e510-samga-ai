...
test('infeasible search preserves the previous valid plan and explicitly reports no new result',async()=>{
 const session=createBriefingSession({request:async path=>path==='/api/search'?{status:'infeasible',scenario:null,validCount:0,eligibleCount:0,constraints:{maxBudget:1}}:{brief:{valid:true},html:'saved'}});
