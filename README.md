...
**Текущий этап: проверяемая расчётная модель и интерактивные прототипы.**
В репозитории есть аналитический сайт с четырьмя фиксированными сценариями и три интерактивных прототипа.
В прототипах доступен произвольный выбор пяти решений. Живой AI-анализ ещё не подключён;
